...
end_per_group(_GroupName, _Config) ->
	application_set(elector, election_delay, 3000),
	application_set(elector, strategy_module, runtime_strategy),
	application_set(elector, sync_start, false),
	application_set(elector, pre_election_hooks, []),
	application_set(elector, post_election_hooks, []).
